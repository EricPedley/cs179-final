...
cam0_to_cam1 = gtsam.Pose3(gtsam.Rot3(), gtsam.Point3(-0.3, 0, 0))
...
def add_vo_factors(
    ...
    camR_start_pose = camL_start_pose.compose(cam0_to_cam1)
...
if __name__ == '__main__':
    ...
    initial_values.insert(Y(0), gtsam.Pose3().compose(cam0_to_cam1))
